...
export const RegisterPage = () => {
  ...
  <div className="h-screen lg:flex lg:w-screen"> 
    ...
    <img src={oiches} className="-z-50 absolute h-1/3 w-full lg:w-1/2 lg:h-screen " alt="" />
    ...
    <div  className="flex flex-col gap-10 pt-5 lg:h-screen lg:gap-y-60">
      ...
      <blockquote className="hidden lg:flex lg:flex-col lg:mx-auto lg:w-1/2">Cuando estoy en el escenario, siento que puedo conquistar el mundo. No hay nada como la energía que recibo del público.Es un intercambio de amor y pasión que no se puede describir con palabras, se se puede sentir <br /><cite className="mt-6">Jimi Hendrick</cite></blockquote>
