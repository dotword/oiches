...
//                     <p className="mb-4">
//                         Eres parte de un grupo musical emergente que sueña con
//                         tocar en los escenarios más vibrantes. Has trabajado
//                         incansablemente para perfeccionar tu sonido y estás
//                         listo para compartirlo con el mundo.
//                     </p>
//                     <p className="mb-4">
//                         Pero hay un obstáculo: encontrar la sala de conciertos
//                         perfecta para tu banda no es fácil. Cada lugar tiene sus
//                         propias características, y coordinar con los
//                         responsables para reservar fechas adecuadas puede ser
//                         una pesadilla logística.
//                     </p>
//                     <p className="mb-4">
//                         Al mismo tiempo, hay salas de conciertos que buscan
//                         constantemente nuevas bandas para llenar sus calendarios
...
//                     </p>
//                     <p className="mb-4">
//                         Ya seas un músico que busca su próximo gran escenario o
//                         un administrador de sala que quiere optimizar su
//                         programación, Oiches es la herramienta que conecta todos
//                         estos mundos.
//                     </p>
