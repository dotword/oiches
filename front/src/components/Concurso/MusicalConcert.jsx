const MusicalConcert = () => {
    return (
        <section className="relative bg-hero-concierto bg-cover bg-center text-white font-kilogram min-h-[60vh] sm:min-h-screen flex items-start sm:items-center justify-center pt-8 sm:pt-0">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="mt-6 sm:mt-8 md:mt-10 text-3xl sm:text-4xl md:text-5xl font-normal flex flex-col md:flex-row md:justify-center md:items-center md:gap-8 uppercase tracking-normal">
                        ...
                        <a
                            ...
                            className="px-6 py-4 sm:py-2 text-base sm:text-lg md:text-xl bg-yellowOiches hover:bg-gradient-to-r hover:from-purpleOiches hover:to-moradoOiches text-white font-['Encode_Sans'] font-bold rounded-lg transition-all hover:scale-105 mt-4 mb-8 md:mb-0 md:mt-0"
