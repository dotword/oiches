...
//                     {/* Botón de ayuda colocado justo debajo de Fotos de la sala */}
//                     <div className="m-auto flex flex-col gap-4 shadow-[0_8px_10px_4px_rgba(0,0,0,0.07)] p-4 items-center rounded-2xl md:mr-0 md:mb-0 md:max-w-80 md:mt-4">
//                         <p className="text-center">
//                             ¿Necesitas ayuda con la publicación?
//                         </p>
//                         <a
