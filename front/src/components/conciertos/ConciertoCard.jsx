...
const ConciertoCard = ({ concierto }) => {
    ...
    return (
        <div className="bg-white rounded-lg shadow-lg mx-auto w-80 max-w-full overflow-hidden">
            {/* Imagen con overlay */}
            ...
            <div className="px-4 pb-6">
                <h2 className="text-xl font-bold">{concierto.artista}</h2>
                <p className="text-gray-600">{concierto.banda_invitada}</p>
