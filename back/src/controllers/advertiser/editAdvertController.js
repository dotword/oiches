...
import editAdSchema from '../../schemas/anunciantes/editAdSchema.js';
import generateErrorsUtil from '../../utils/generateErrorsUtil.js';

const editAdvertController = async (req, res, next) => {
    try {
        ...
        await validateSchemaUtil(editAdSchema, req.body);
...
export default editAdvertController;
