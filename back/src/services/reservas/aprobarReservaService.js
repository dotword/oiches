...
const aprobarReservaService = async (reserva_id) => {
    try {
        ...
        // Comprobar que la reseva se está tramitando
        if (reservaConfirm !== '2') {
            throw generateErrorsUtil(
                'Tienes que tramitar primero la reserva para poder confirmarla',
                404
            );
        }
        ...
        const emailSubject = `¡Tu concierto en ${nameSala} está confirmado!`;
        ...
        const emailBody = `
                ...
                <body>
                    ...
                    <p>¡Enhorabuena! Tu concierto en la sala <b>${nameSala}</b> ha sido confirmado para el día ${formatedFecha}.</p> <p>Asegúrate de coordinar los últimos detalles con la sala entrando en <a href="${URL_FRONT}/login">tu cuenta</a>. Allí también podrás gestionar cualquier aspecto adicional relacionado con el evento.</p> <p>Estamos emocionados de que formes parte de esta experiencia. ¡Te deseamos mucho éxito en tu próximo concierto! </p>
                    <p>Gracias por confiar en nosotros para hacer esto posible.</p>
