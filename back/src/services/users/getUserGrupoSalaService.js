...
const getUserGrupoSalaService = async (name) => {
  try {
    ...
    grupos.forEach(grupo => {
      const { id, nombre, provincia, honorarios, honorarios_to, biografia, usuario_id, createdAt, updatedAt, deletedAt, grupoId, foto_url } = grupo;
    ...
    salas.forEach(sala => {
      const { id, nombre, provincia, honorarios, honorarios_to, biografia, usuario_id, createdAt, updatedAt, deletedAt, salaId, foto_url } = sala;
