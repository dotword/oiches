...
export async function listGruposService(filters, sort) {
    ...
    query +=
        ' GROUP BY g.id, g.nombre, g.email, g.usuario_id, p.provincia, gm.nombre, gf.name';
